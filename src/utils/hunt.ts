...
const lowEncounterAverages = [
    ...
    { worldLevel: 6, minHp: 75, maxHp: 100, minDamage: 14, maxDamage: 25 },
    { worldLevel: 7, minHp: 100, maxHp: 150, minDamage: 18, maxDamage: 35 },
    { worldLevel: 8, minHp: 150, maxHp: 250, minDamage: 25, maxDamage: 40 },
    { worldLevel: 9, minHp: 200, maxHp: 300, minDamage: 30, maxDamage: 50 },
    { worldLevel: 10, minHp: 250, maxHp: 325, minDamage: 40, maxDamage: 60 },
    { worldLevel: 11, minHp: 275, maxHp: 350, minDamage: 50, maxDamage: 65 },
