        ...
        .addFields(
            {
                ...
                value: `\`${messages}/${nearestMessages}\` | ${customEmoji.a.z_coins} **+${economy.mora.quests.messages} Mora**, +1 Reputation`,
            },
            {
                name: "✦ Activity Rewards",
                value: `\`${activeTime}/${nearestTime} Minutes\` | ${customEmoji.a.z_coins} **+${economy.mora.quests.activity} Mora**, +1 Reputation`,
            },
        )
        .setFooter({
